<template>
  <div>
    <div class="goods">
      ...
      <shopcart ref="shopcart" :delivery-price="seller.deliveryPrice" :min-price="seller.minPrice" :select-foods="selectFoods"/>
    </div>
    <food :food="selectedFood" @add="addFood" ref="food"/>
  </div>
</template>
...
export default {
    ...
    methods: {
        ...
        _drop(target) {
            this.$nextTick(() => { // 优化体验, 异步执行, 用户第一次点击时会有另外一个动画.
